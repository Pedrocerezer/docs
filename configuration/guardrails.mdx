...
description: "Guardrails define what your Jobr AI employee (AI agent) can and cannot do — set limits, approved actions, and off-limits topics for safe operation."
---
